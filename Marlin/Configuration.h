...
#define STRING_CONFIG_H_AUTHOR "(Stefan, GT2560)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Stefan's hub"
...
#define MAX_BED_POWER 126 // limits duty cycle to bed; 255=full current
